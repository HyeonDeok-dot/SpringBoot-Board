...
public class JpaBoardController {
	...
	@RequestMapping(value="/jpa/board", method=RequestMethod.GET) //URI에 jpa를 붙여서 JPA용 URI임을 나타냄
	...
	public String updateBoard(BoardEntity board) throws Exception{
		jpaBoardService.saveBoard(board, null); //JPA의 save메서드는 insert와 update 두 가지 역할을 모두 수행
		return "redirect:/jpa/board";
	}
